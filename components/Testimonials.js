...
const Testimonials = () => {
  return (
    <div id="testimonials">
      <section className="body-font bg-gray-50 text-gray-600">
        <div className="container mx-auto px-5 py-24">
          <div className="mx-auto w-full text-center lg:w-3/4 xl:w-1/2">
            ...
            <span className="mt-8 mb-6 inline-block h-1 w-10 rounded bg-green-500"></span>
            <h2 className="title-font text-sm font-medium tracking-wider text-gray-900">
              HOLDEN CAULFIELD
            </h2>
            <p className="text-gray-500">Vegan Bazz dev</p>
          </div>
        </div>
      </section>
    </div>
